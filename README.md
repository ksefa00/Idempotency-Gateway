...
A REST API that ensures payment requests are processed **exactly once** using an `Idempotency-Key` header. Duplicate requests replay the original response without re-processing.
